...
class Library {
  ...
  // Create library object instance; recall const catalogObject = new Catalog... from CIS 111
const library = new Library("Phil Knight Library");
...
console.log("* Library after adding 1 book *");
...
console.log("* Library after adding more books *");
